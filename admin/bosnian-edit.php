...
$sqlquery2 = "SELECT * FROM content WHERE id=1";
if ($result2 = mysqli_query($conn, $sqlquery2)){
  $ba = mysqli_fetch_array($result2);
}
...
<form class="" action="update-content.php" method="post">
 <div class="row">
   ...
   <div class="col-6">
     <input type="text" name="header_0" value="<?php echo $ba['header_0'] ?>">
   </div>
   ...
   <div class="col-6">
     <input type="text" name="header_1" value="<?php echo $ba['header_1'] ?>">
   </div>
   ...
   <div class="col-6">
     <input type="text" name="services_h2_1" value="<?php echo $ba['services_h2_1'] ?>">
   </div>
   ...
   <div class="col-6">
     <textarea name="services_span_1" rows="2" cols="80"><?php echo $ba['services_span_1'] ?></textarea>
   </div>
   ...
   <div class="col-6">
     <input type="text" name="services_h2_2" value="<?php echo $ba['services_h2_2'] ?>">
   </div>
   ...
   <div class="col-6">
     <textarea name="services_span_3" rows="2" cols="80"><?php echo $ba['services_span_3'] ?></textarea>
   </div>




   <input type="text" name="id" value="<?php echo $ba['id'] ?>" style="display: none">
