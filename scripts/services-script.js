...
var top;
var showed = [false, false, false, false, false, false, false, false, false, false];
$(window).scroll( function() {
    ...
    if ($(this).scrollTop() > $("#shower-6").offset().top-250 && !showed[6]){
      $('#shower-6').removeClass('shower-down', 1000);
      showed[6] = true;
    }
    if ($(this).scrollTop() > $("#shower-7").offset().top-250 && !showed[7]){
      $('#shower-7').removeClass('shower-down', 1000);
      showed[7] = true;
    }
    if ($(this).scrollTop() > $("#shower-8").offset().top-250 && !showed[8]){
      $('#shower-8').removeClass('shower-down', 1000);
      showed[8] = true;
    }
    if ($(this).scrollTop() > $("#shower-9").offset().top-550 && !showed[9]){
      $('#shower-9').removeClass('shower-down', 1000);
      showed[9] = true;
    }
});
