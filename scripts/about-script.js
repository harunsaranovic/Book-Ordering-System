...
var showed = [false, false, false, false, false, false]
$(window).scroll( function() {
    if ($(this).scrollTop() > $("#shower-1").offset().top-200 && !showed[1]){
      $('#shower-1').removeClass('shower-down', 1000);
      showed[1] = true;
    }
    if ($(this).scrollTop() > $("#shower-2").offset().top-200 && !showed[2]){
      $('#shower-2').removeClass('shower-down', 1000);
      showed[2] = true;
    }
    if ($(this).scrollTop() > $("#shower-3").offset().top-100 && !showed[3]){
      $('#shower-3').removeClass('shower-down', 1000);
      showed[3] = true;
    }
    if ($(this).scrollTop() > $("#shower-4").offset().top-500 && !showed[4]){
